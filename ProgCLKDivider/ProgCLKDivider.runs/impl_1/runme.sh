...
HD_PWD='D:/FPGAHardwareDesign/ProgCLKDivider/ProgCLKDivider.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_CLKDivider.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_CLKDivider.tcl -notrace
