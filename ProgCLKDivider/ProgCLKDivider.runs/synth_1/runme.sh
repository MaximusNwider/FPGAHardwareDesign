...
HD_PWD='D:/FPGAHardwareDesign/ProgCLKDivider/ProgCLKDivider.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_CLKDivider.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_CLKDivider.tcl
