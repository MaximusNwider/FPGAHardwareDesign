...
HD_PWD='C:/Users/man01/OneDrive/Desktop/351_Lab1/351_Lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFOPsuedo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIFOPsuedo.tcl
