...
entity FA16BIT is
    ...
    PORT (
        A_IN : IN std_logic_vector(Data_SIZE-1 downto 0) := (others=>'0');
        B_IN : IN std_logic_vector(Data_SIZE-1 downto 0):= (others=>'0');
        C_IN : IN std_logic := '0';
        S_OUT : OUT std_logic_vector(Data_SIZE-1 downto 0):= (others=>'0');
...
component FullAdder3to1
    Port (
      ...
      signal  S :  std_logic_vector(Data_SIZE-1 downto 0) := (others=>'0');
...
begin
    ...
    Add: for N in 0 to Data_SIZE-1 generate
